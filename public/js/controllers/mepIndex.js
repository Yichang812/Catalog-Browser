...
angular.module('ace.system').controller('mepIndexController', ['$scope', 'Global', '$rootScope', '$cookieStore', '$location', 'navBarMenu', function ($scope, Global, $rootScope, $cookieStore, $location, navBarMenu) {
    $scope.global = Global;
    $scope.nav_menu = [];
    $scope.showSide = true;
    $scope.selected = null;
	...
	// 	    	$scope.prdt = $scope.ACA;
        if (document.URL.indexOf('ACADMEP') > -1) {
    ...
    if ($scope.global.authenticated) {
        // if(Global.user.userViewChoice === null){
        ...
        // }
        // else {
        //     if (Global.user.userViewChoice === 'AutoCAD MEP') {
        //     $scope.favLinkPage = 'mepFavourites.html';
        //     $scope.manageCatalog = 'mepManageCatalog.html';
        // }
        //      else {
        ...
        //           $scope.manageCatalog = 'manageCatalog.html';
        //      }
        //      Global.user.userViewChoice = null;
        // }
